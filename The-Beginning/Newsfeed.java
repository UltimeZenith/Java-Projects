public class Newsfeed {
    ...
    public void changeRanting(int articleNumber, double newRating){
        if(newRating > 5 || newRating < 0){
            System.out.println("The rating must be between 0 and 5 stars!");
        }else {
            ratings[articleNumber] = newRating;
            System.out.println("The rating '" + trendingArticles[articleNumber] + "' is now rated " + ratings[articleNumber] + " stars!");
        }
    }
